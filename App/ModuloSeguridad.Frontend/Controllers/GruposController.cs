...
namespace ModuloSeguridad.Frontend.Controllers
{
    public class GruposController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GrupoId,Nombre,EstadoGrupoId,Eliminado,FechaCreacion,FechaActualizacion,FechaEliminacion,CreadoPor,ActualizadoPor,EliminadoPor")] Grupo grupo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GrupoId,Nombre,EstadoGrupoId,Eliminado,FechaCreacion,FechaActualizacion,FechaEliminacion,CreadoPor,ActualizadoPor,EliminadoPor")] Grupo grupo)
        {
            if (id != grupo.GrupoId)
            {
                return NotFound();
